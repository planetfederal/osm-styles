DROP MATERIALIZED VIEW IF EXISTS "aero-poly";

CREATE MATERIALIZED VIEW "aero-poly" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "agriculture";

CREATE MATERIALIZED VIEW "agriculture" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "amenity-areas";

CREATE MATERIALIZED VIEW "amenity-areas" AS (
...
DROP MATERIALIZED VIEW IF EXISTS "beach";
...
DROP MATERIALIZED VIEW IF EXISTS "building";
...
DROP MATERIALIZED VIEW IF EXISTS "forest";

CREATE MATERIALIZED VIEW "forest" AS ( SELECT *, (CASE 
...
DROP MATERIALIZED VIEW IF EXISTS "grass";

CREATE MATERIALIZED VIEW "grass" AS ( SELECT way,landuse, (CASE 
...
DROP MATERIALIZED VIEW IF EXISTS "highway-label";

CREATE MATERIALIZED VIEW "highway-label" AS (
...
DROP MATERIALIZED VIEW IF EXISTS "park";

CREATE MATERIALIZED VIEW "park" AS ( SELECT *, (CASE 
...
DROP MATERIALIZED VIEW IF EXISTS "parking-area";

CREATE MATERIALIZED VIEW "parking-area" AS (
...
DROP MATERIALIZED VIEW IF EXISTS "placenames-medium";

CREATE MATERIALIZED VIEW "placenames-medium" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-0";

CREATE MATERIALIZED VIEW "route-bridge-0" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-1";

CREATE MATERIALIZED VIEW "route-bridge-1" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-2";

CREATE MATERIALIZED VIEW "route-bridge-2" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-3";

CREATE MATERIALIZED VIEW "route-bridge-3" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-4";

CREATE MATERIALIZED VIEW "route-bridge-4" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-bridge-5";

CREATE MATERIALIZED VIEW "route-bridge-5" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-fill";

CREATE MATERIALIZED VIEW "route-fill" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-line";

CREATE MATERIALIZED VIEW "route-line" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-tunnels";

CREATE MATERIALIZED VIEW "route-tunnels" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "route-turning-circles";

CREATE MATERIALIZED VIEW "route-turning-circles" AS ( SELECT highway,way FROM planet_osm_point
...
DROP MATERIALIZED VIEW IF EXISTS "water-outline";

CREATE MATERIALIZED VIEW "water-outline" AS ( 
...
DROP MATERIALIZED VIEW IF EXISTS "water";
...
DROP MATERIALIZED VIEW IF EXISTS "wetland";

CREATE MATERIALIZED VIEW "wetland" AS (
